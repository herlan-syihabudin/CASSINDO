  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <>
            {/* Backdrop dengan blur - lebih transparan */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            {/* Menu Panel - Premium Glass Effect */}
            <motion.div
            ...
            >
              <div className="flex flex-col min-h-full pt-16 pb-8">
                ...
                {/* SECTION 1: Quick Contact - Premium Card */}
                ...
                {/* SECTION 2: Navigation - Premium List */}
                <div className="px-6 mb-6">
                  <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider mb-3 flex items-center gap-2">
                    <span className="w-1.5 h-1.5 bg-primary rounded-full" />
                    Menu
                ...
                {/* SECTION 3: CTA Card - Dominant Conversion */}
